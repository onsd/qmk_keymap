...
[BASE] = KEYMAP( \
 ...
 MO(META), MO(SYMB),TG(META), TG(SYMB) , KC_LGUI,        KC_ESC,        KC_SPC,        KC_SPC,    KC_MS_BTN1,     KC_MS_BTN2, KC_MINS, KC_MS_D,  TG(SYMB), TG(META) \
),
...
[META] = KEYMAP( \
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,  KC_0,    KC_MINS, KC_EQL, S(KC_BSLS),   \
  _______, KC_F1,   XXXXXXX, KC_MHEN, KC_HENK, XXXXXXX, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX, XXXXXXX, \
...
[SYMB] = KEYMAP( \
   _______,S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8), S(KC_9),    S(KC_0),   S(KC_MINS), S(KC_EQL), _______, \
